...
class EncodeNet(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = nn.Conv2d( in_channels, chan, 3, padding=1)
        self.conv_list = nn.ModuleList([])
        _c = chan
        for i in range(n_layer):
            self.conv_list.append(nn.Conv2d( _c, _c*2, 3, padding=1, stride=2))
            _c *= 2
        self.conv2 = nn.Conv2d( _c, out_channels, 3, padding=1)
